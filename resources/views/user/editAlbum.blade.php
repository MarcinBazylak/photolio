...
<form action="/panel/album/{{ $album->id }}/edit" method="post">
   ...
   <div>
      <input placeholder="{{ $album->album_name ??'' }}" type="text" class="form-control @error('album_name') is-invalid @enderror" name="album_name" id="album_name" required autocomplete="off" autofocus>
